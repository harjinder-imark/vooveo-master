...
function my_taxonomies_client() {
	...
	register_taxonomy( 'client_category', 'client', $args );
}
add_action( 'init', 'my_taxonomies_client');
...
function my_custom_testimonials() {
	$labels = array(
		'name' => 'Testimonials',
...
add_action( 'init', 'my_custom_testimonials' );



function custom_pricing_and_packages_post() {
	$labels = array(
		'name' => 'Pricing and Packages',
		'menu_name' => 'Custom pricing post',
	...
	register_post_type( 'Pricing and Packages', $args ); 
}

add_action( 'init', 'custom_pricing_and_packages_post' );




function custom_story_step_post() {
	$labels = array(
		'name' => 'Steps',
		'menu_name' => 'Custom step post',
		'add_new' => 'Add New Step',
		'edit_item' => 'Edit Step',
		'not_found' => 'No Step Found',
...
add_action( 'init', 'custom_story_step_post' ); 
